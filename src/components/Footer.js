        ...
        <div className="footer-grid">
          ...
          <div className="footer-about">
            <Link href="/" className="logo">
              <img
                src="/images/Edulink Logo-02.png"
                alt="EduLink Logo"
                style={{ height: "70px", width: "auto" }}
              />
            </Link>
            <p>
              EduLink International Campus is committed to providing world-class
              education, fostering innovation, and shaping future leaders. Join
              our community of passionate learners from around the globe.
            </p>
          ...
          <div className="footer-col">
            ...
            <div className="footer-contact-item">
              ...
              <a
                href="https://www.google.com/maps/place/6+Glen+Aber+Pl,+Colombo+00300/@6.8955932,79.8544076,17z/data=!3m1!4b1!4m6!3m5!1s0x3ae25bde569fa639:0x5f2ce31e75b8439f!8m2!3d6.8955932!4d79.8544076!16s%2Fg%2F11l7814krr?authuser=0&entry=ttu&g_ep=EgoyMDI2MDUwMi4wIKXMDSoASAFQAw%3D%3D"
                target="_blank"
                rel="noopener noreferrer"
              >
                6 Glen Aber Road Colombo, colombo, Srilanka, 004
              </a>
            </div>
            <div className="footer-contact-item">
              <span className="footer-contact-icon">📞</span>
